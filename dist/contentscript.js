...
var _mutationSummary = __webpack_require__(1);
...
var observer = new _mutationSummary2.default({
  callback: function callback(summaryObjects) {
    summaryObjects[0].added.forEach(function (el) {
      el.scrollTop = 0;
    });
  },
  queries: [{ element: '#js-detail-nav-content' }]
});
